...
var Form = util.Form;
var safeMobile = util.safeMobile;
...
var propogandaScroll = {
  ...
  formSubmit: function(){
    ...
    var _mobile = safeMobile($('#J_mobile').val());
    if ($btn.data('init')){
      return;
    }
    $btn.data('init', 1);
  ...
  downloadStatistics: function() {
    $('.landing-carnival-backtop').click(function() {
      trackEvent('H5', 'downloadApp', 'LP-promotionRegister');
    });
  },
  init: function(opt){
    var me =this;
